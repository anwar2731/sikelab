...
public class PengajuanM {
     ...
     e.printStackTrace();
      ...
      public Pengajuan getPengajuanIdAIL(String id_pengajuan){
         Pengajuan tempAju = new Pengajuan();
        try {
          String pwd ="";
          String login = "root";
          ...
          Akses db = new Akses("sikelab",login,pwd);
          con = db.connect();
          rs = db.executeQuery("select * from pengajuan where id_pengajuan = '"+id_pengajuan+"'");
          while(rs.next()){
               tempAju.setId_Pengajuan(rs.getString("id_pengajuan"));
                tempAju.setStatus(rs.getString("status"));
                tempAju.setNama_Barang(rs.getString("nama_barang"));
     ...
     public boolean updateStatus(Pembelian dtPgS){
        boolean success = false;
        String pwd ="";
        String login = "root";
        Akses db = new Akses("sikelab",login,pwd);
        ...
        String insert=null;
        try{
         insert = "update pembelian set status = '"+dtPgS.getStatus()+"' where id_pembelian = '"+dtPgS.getId_Pembelian()+"'";
        con=db.connect();
